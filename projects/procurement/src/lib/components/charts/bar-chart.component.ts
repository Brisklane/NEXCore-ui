...
@Component({
  ...
  styles: [`
    ...
    .bc-label { font-size: 12.5px; color: var(--text-primary, #475569); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    .bc-track { background: var(--chart-track, #f1f5f9); border-radius: 6px; height: 18px; overflow: hidden; }
    .bc-fill { height: 100%; border-radius: 6px; min-width: 2px; transition: width .5s ease; }
    .bc-value { font-size: 12.5px; font-weight: 600; color: var(--text-heading, #1e293b); text-align: right; }
    .bc-empty { color: var(--text-muted, #94a3b8); font-size: 13px; padding: 16px; text-align: center; }
  `],
})
export class BarChartComponent {
  ...
  private readonly palette = ['var(--kpi-1, #2b7fff)', 'var(--kpi-2, #0ea5e9)', 'var(--kpi-5, #10b981)', 'var(--kpi-4, #f59e0b)', 'var(--kpi-6, #ef4444)', 'var(--kpi-3, #8b5cf6)', 'var(--violet, #ec4899)', 'var(--brand-cyan, #14b8a6)'];
